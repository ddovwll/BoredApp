...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670617, ; uint32_t jnienv_initialize_method_token (0x6001c99)
	i32 100670616, ; uint32_t jnienv_registerjninatives_method_token (0x6001c98)
...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 543905461751105018, ; hash 0x78c5722bf11c5fa, from name: aot-BoredApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 18
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2650097207445274194, ; hash 0x24c7095e8e07be52, from name: BoredApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 93
	...
	%struct.DSOCacheEntry {
		i64 2789010184297286945, ; hash 0x26b48dfc5dfc8d21, from name: BoredApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 97
	%struct.DSOCacheEntry {
		i64 2801959859840120054, ; hash 0x26e28fa5a8ac74f6, from name: libaot-BoredApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 98
	...
	%struct.DSOCacheEntry {
		i64 3247019097748821070, ; hash 0x2d0fbaaa7c3a544e, from name: aot-BoredApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 115
	...
	%struct.DSOCacheEntry {
		i64 4445511572594588065, ; hash 0x3db1a138d16379a1, from name: libaot-BoredApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
...
@.env.3 = private unnamed_addr constant [37 x i8] c"c4e94618-28ca-45b0-bac8-07909cd5d646\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.boredapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [23 x i8] c"libaot-BoredApp.dll.so\00", align 16
