...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 115559751, ; hash 0x6e34d47, from name: BoredApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 456498091, ; hash 0x1b359bab, from name: libaot-BoredApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 57
	...
	%struct.DSOCacheEntry {
		i64 1019771473, ; hash 0x3cc87a51, from name: aot-BoredApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 136
	...
	%struct.DSOCacheEntry {
		i64 1048672958, ; hash 0x3e817abe, from name: BoredApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 142
	...
	%struct.DSOCacheEntry {
		i64 2024954516, ; hash 0x78b25a94, from name: aot-BoredApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 290
	...
	%struct.DSOCacheEntry {
		i64 4157903151, ; hash 0xf7d4912f, from name: libaot-BoredApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BoredApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 608
